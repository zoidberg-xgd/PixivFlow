 ...
 */
export async function getDownloadStats(req: Request, res: Response): Promise<void> {
  let database: Database | null = null;
  try {
 ...
 * Get tag statistics
 */
export async function getTagStats(req: Request, res: Response): Promise<void> {
  let database: Database | null = null;
  try {
 ...
 */
export async function getAuthorStats(req: Request, res: Response): Promise<void> {
  let database: Database | null = null;
  try {
    const { limit = 10 } = req.query;
    const configPath = getConfigPath();
