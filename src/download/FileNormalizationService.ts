...
import { FileService, PixivMetadata } from './FileService';
...
export class FileNormalizationService {
  ...
  private normalizeFileName(fileName: string, metadata: PixivMetadata): string {
  ...
  private async loadMetadataForFile(
    filePath: string,
    fileType: 'illustration' | 'novel'
