...
**使用与配置**
- [🎯 使用场景](#使用场景)
  - [场景一：每日自动收集灵感素材](#场景-1每日自动收集灵感素材)
  - [场景二：服务器定时收集特定标签](#场景-2服务器定时收集特定标签)
  - [场景三：快速体验 - 随机下载](#场景-3快速体验-随机下载)
  - [场景四：一次性批量下载](#场景-4一次性批量下载)
- [📁 项目结构](#项目结构)
- [⚙️ 核心配置](#核心配置)
  - [认证配置](#认证配置)
  - [下载目标](#下载目标)
...
- [🐛 常见问题](#常见问题)
  ...
  - [❓ 找不到匹配的作品？](#找不到匹配的作品)
  - [❓ 如何仅获取"昨天"的热门内容？](#如何仅获取昨天的热门内容)
  - [❓ 如何限制总量并使用多标签并集（任意一个标签即可）？](#如何限制总量并使用多标签并集任意一个标签即可)
  - [❓ 定时任务没有运行？](#定时任务没有运行)
  - [❓ 下载速度慢或经常失败？](#下载速度慢或经常失败)
  - [❓ 遇到已删除或私有的作品？](#遇到已删除或私有的作品)
  - [❓ Android/Termux 安装失败？](#androidtermux-安装失败)
  - [🔍 查看详细日志](#查看详细日志)
- [🔒 安全提示](#安全提示)
- [📊 下载记录管理](#下载记录管理)
- [🚀 进阶使用](#进阶使用)
